...
{
    [TestFixture]
    public class AllTasksInquiryProcessorTests
    {
        ...
        public void SetUp()
        {
            ...
            _inquiryProcessor =
                new AllTasksInquiryProcessorTestDouble
                (_autoMapperMock.Object, _commonLinkServiceMock.Object,
                _taskLinkServiceMock.Object,
                _allTasksQueryProcessorMock.Object);
        }
        ...
        public void GetTasks_adds_links()
        {
            ...
            _inquiryProcessor.AddLinksToInquiryResponseTestDouble =
                ...
                && response.PageCount == queryResult.TotalItemCount
        ...
        public void GetTasks_adds_self_link_to_tasks()
        {
            ...
            for (var i = 0; i < taskEntities.Count; ++i)
            {
                ...
                _autoMapperMock.Setup(x => x.Map<Models.Task>(taskEntities[index]))
                    .Returns(tasks[index]);
                _taskLinkServiceMock.Setup(x => x.AddSelfLink(tasks[index]))
                    .Verifiable();
            }
